...
## Report bugs using Github's [issues](https://github.com/rickstaa/.pathmod/issues)

We use GitHub issues to track public bugs. Report a bug by [opening a new issue](https://github.com/rickstaa/.pathmod/issues/new/choose); it's that easy!
